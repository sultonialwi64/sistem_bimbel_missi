...
<div class="space-y-8">
    ...
    <div class="flex justify-between items-center">
        <div>
            <p class="text-gray-500">Kelola gaji tutor dan bagi hasil perusahaan</p>
        </div>
        <button
            onclick="document.getElementById('modal-generate').classList.remove('hidden')"
            class="btn-primary-gradient text-white font-bold px-6 py-3 rounded-2xl hover:shadow-2xl flex items-center gap-3 shadow-xl shadow-green-500/30">
