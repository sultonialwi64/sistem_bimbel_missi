        ...
        <form action="{{ route('admin.clients.update', $client) }}" method="POST">
            ...
            <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="address" rows="3" required
                                      class="mt-1 block w-full rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">{{ old('address', $client->address) }}</textarea>
                        </div>
                ...
                <div class="flex justify-end gap-3 pt-4 border-t">
                    <a href="{{ route('admin.clients.index') }}" class="px-4 py-2 text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200">
                        Cancel
                    </a>
