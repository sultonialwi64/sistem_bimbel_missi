                ...
                <div class="pl-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-400 mt-1">Kosongkan untuk mempertahankan password saat ini.</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <textarea name="address" rows="3" required
                                      ...
                                      placeholder="Jl. Contoh No. 1, RT/RW, Kelurahan, Kecamatan, Kota">{{ old('address', $client->address) }}</textarea>
                            @error('address')<p class="form-error">{{ $message }}</p>@enderror
                        </div>

                        <div>
                            <label class="form-label">Kontak Darurat</label>
                            <input type="text" name="emergency_contact" value="{{ old('emergency_contact', $client->emergency_contact) }}"
                                   class="input-premium"
                                   placeholder="08xxxxxxxxx">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="client_type" required class="input-premium @error('client_type') border-red-500 @enderror">
                                <option value="tipe_2" {{ old('client_type', $client->client_type) == 'tipe_2' ? 'selected' : '' }}>Tipe 2 — Rp 50.000 / sesi</option>
                                <option value="tipe_1" {{ old('client_type', $client->client_type) == 'tipe_1' ? 'selected' : '' }}>Tipe 1 — Rp 45.000 / sesi</option>
                            </select>
