...
<div class="max-w-6xl mx-auto space-y-6">
    <!-- Back Button -->
    <a href="{{ route('admin.clients.index') }}" class="inline-flex items-center text-indigo-600 hover:text-indigo-800">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="text-center">
                    ...
                    <div class="mt-4 flex justify-center gap-2">
                        <a href="{{ route('admin.clients.edit', $client) }}" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 text-sm">
                            Edit
                        </a>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="{{ route('admin.students.create') }}" class="text-sm text-indigo-600 hover:text-indigo-800">Add Child</a>
                </div>
                <div class="space-y-3">
                    @forelse($client->students as $student)
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            ...
                            <a href="{{ route('admin.students.show', $student) }}" class="text-indigo-600 hover:text-indigo-900">View</a>
                        </div>
                    @empty
