                ...
                <tbody>
                    @forelse($payments as $payment)
                        <tr class="group">
                            ...
                            <td class="py-4 px-6">
                                @php
                                    // Periode = bulan tagihan, dihitung dari due_date (jatuh tempo = akhir bulan + 7 hari)
                            ...
                            <td class="py-4 px-6 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    @if($payment->status !== 'paid' && $payment->client->user->phone)
                                        ...
                                        @endphp
                                        <a href="{{ $waUrl }}" target="_blank" class="inline-flex items-center gap-1.5 px-4 py-2 bg-green-600 text-white border border-green-700 rounded-xl font-bold text-xs hover:bg-green-700 shadow-sm hover:shadow-md transition-all !important" title="Kirim Tagihan & Rapor via WA">
                                            <svg class="h-4 w-4 fill-current" viewBox="0 0 24 24">
                                                <path d="M12.031 6.172c-3.181 0-5.767 2.586-5.768 5.766-.001 1.298.38 2.27 1.019 3.287l-.582 2.128 2.182-.573c.978.58 1.911.928 3.145.929 3.178 0 5.767-2.587 5.768-5.766.001-3.187-2.575-5.77-5.764-5.771zm3.392 8.244c-.144.405-.837.774-1.17.824-.299.045-.677.063-1.092-.069-.252-.08-.575-.187-.988-.365-1.739-.751-2.874-2.502-2.961-2.617-.087-.116-.708-.94-.708-1.793s.441-1.273.606-1.446c.163-.173.353-.217.473-.217l.361.002c.118.002.277-.044.433.33.161.385.55 1.341.599 1.442.049.101.082.218.01.389-.071.171-.108.277-.215.398-.109.122-.23.267-.327.369-.108.114-.222.24-.097.455.124.216.55 0.912 1.178 1.472.812.723 1.498.948 1.708 1.054.21.106.331.088.455-.052.124-.14 0.536-.622.682-.835.145-.213.291-.177.485-.104.195.072 1.229.58 1.439.685.21.105.351.157.402.244.051.087.051.503-.093.908z" />
                                            </svg>
                                            WHATSAPP
                                        </a>
                                    @endif
