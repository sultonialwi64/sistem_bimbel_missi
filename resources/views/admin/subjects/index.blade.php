...
<div class="space-y-8">
    <div class="flex justify-between items-center">
        <div>
            <p class="text-gray-500">Manage subjects and levels</p>
        </div>
        <a href="{{ route('admin.subjects.create') }}" class="btn-primary-gradient text-white font-bold px-6 py-3 rounded-2xl hover:shadow-2xl flex items-center gap-3 shadow-xl shadow-indigo-500/30">
