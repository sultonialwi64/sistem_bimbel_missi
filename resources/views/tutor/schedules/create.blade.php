...
@section('page-subtitle', 'Tambahkan jadwal mengajar Anda')
...
<div class="max-w-3xl mx-auto">
    <div class="card-premium overflow-hidden">
        ...
        <div class="bg-indigo-800 px-6 py-4">
            ...
            <p class="text-indigo-300 text-sm mt-0.5">Jadwal ini akan masuk ke daftar jadwal Anda dan jadwal anak.</p>
        </div>

        <form action="{{ route('tutor.schedules.store') }}" method="POST">
            @csrf
