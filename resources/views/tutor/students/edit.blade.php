...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('tutor.students.update', $student) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="space-y-4">
                <div>
                ...
                <div class="flex justify-end gap-3 pt-4 border-t">
                    <a href="{{ route('tutor.students.index') }}" class="px-4 py-2 bg-gray-100 rounded-lg">Cancel</a>
