...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('tutor.students.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div class="flex justify-end gap-3 pt-4 border-t">
                    <a href="{{ route('tutor.students.index') }}" class="px-4 py-2 text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200">
                        Cancel
                    </a>
