...
<div class="space-y-8">
    <div class="flex justify-between items-center">
        <div>
            <p class="text-gray-500">Manage clients and their information</p>
        </div>
        <a href="{{ route('tutor.clients.create') }}" class="btn-primary-gradient text-white font-bold px-6 py-3 rounded-2xl hover:shadow-2xl flex items-center gap-3 shadow-xl shadow-indigo-500/30">
                        ...
                        <tr class="group">
                            ...
                            <td class="py-4 px-6 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('tutor.clients.show', $client) }}" class="inline-flex items-center gap-1.5 px-4 py-2 bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-700 rounded-xl font-semibold text-sm hover:shadow-lg hover:shadow-blue-500/20 transition-all">
                                    ...
                                    <a href="{{ route('tutor.clients.edit', $client) }}" class="inline-flex items-center gap-1.5 px-4 py-2 bg-gradient-to-r from-amber-50 to-orange-50 text-amber-700 rounded-xl font-semibold text-sm hover:shadow-lg hover:shadow-amber-500/20 transition-all">
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                        </svg>
                                        Edit
                                    </a>
                                    <form action="{{ route('tutor.clients.destroy', $client) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure?');">
                                        @csrf
                                        @method('DELETE')
